...
const CandyMachine = ({ walletAddress }) => {
  ...
  const renderButtons = () => {
	if (isMinting) {
		return <button className="cta-button mint-button" onClick={mintToken} >Mint NFT</button>;
	} else {
		<button className="cta-button disabled-button" >Minting Your NFT...</button>;
	}
  ...
  return (
    machineStats && (
	  <div className="machine-container">
	    ...
	    {isLoadingMints && <p className="loading">Loading minted NFT's...</p>}
